...
class AverageProofs {
     ...
     * truncating integer division of a correctly-computed sum. A REFUTED verdict witnesses inputs
     * where the result escapes the [min,max] band — only possible if the intermediate `sum`
     * overflowed Int. (Expected REFUTED — see report.)
     */
