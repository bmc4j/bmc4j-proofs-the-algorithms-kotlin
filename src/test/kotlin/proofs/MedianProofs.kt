...
class MedianProofs {
    ...
    /**
     * CONTRACT: median(a, b) lies between min(a,b) and max(a,b). This is a plain proof of the real
     * contract: it REFUTES, so this test FAILS — bmc4j produces inputs whose Int sum overflows
     * before the `/ 2.0`, yielding a median outside the data range. Same Int-overflow class as
     * average.
     */
    @BmcProof(unwind = 4)
